...
file_format: 1
    ...
    def generate(self, module_name, parameters, input_ports, output_ports):
        """
        Generate YAML content for a GNU Radio module
        ...
        Notes
        -----
        This function generates YAML content for a GNU Radio module using the
        template provided in the class. The template is a string that contains
        placeholders for the module name, parameters, input ports and output
        ports. The placeholders are replaced with the actual values provided as
...
'''
    ...
    def get_yml_content(self):
        """
        Returns the content of the YAML file generated by the generate_yaml()
        method.
        """
